                            ...
                            <div class="col-xl-4 col-lg-4">
                                ...
                                <div class="post-details4  mb-50">
                                    ...
                                    <ul>
                                        ...
                                        <li>Web : <a href="<%# Eval("Website") %>"><span> <%# Eval("Website") %> </span></a></li>
                                        <li>Email: <a href="https://mail.google.com/mail/u/0/?fs=1&to=<%# Eval("Email") %>&tf=cm"><span><%# Eval("Email") %></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
