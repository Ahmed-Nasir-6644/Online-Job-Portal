                    ...
                    <div class="form-contact contact_form">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTenth" runat="server" CssClass="form-control" placeholder="Example: 90% " required>
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTwelfth" runat="server" CssClass="form-control" placeholder="Example: 90% " required>
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtGraduation" runat="server" CssClass="form-control" placeholder="Example: BSCS with 3.37cgpa" required>
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPostGraduation" runat="server" CssClass="form-control" placeholder="Example: MSCS with 3.87cgpa" required>
                                </asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Experience" required>
                                </asp:TextBox>
                            </div>
                        </div>
